export class ActionsType{
     public static readonly  DELETE_BOOK_REQUEST = 'DELETE_BOOK_REQUEST'
     public static readonly  GET_BOOK_REQUEST = 'GET_BOOK_REQUEST'
     public static readonly  GET_BOOK_SUCESS = 'GET_BOOK_SUCESS'
